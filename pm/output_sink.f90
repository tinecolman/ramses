subroutine output_sink_csv(filename)
  ...
  write(123,'(" # id,msink,x,y,z,vx,vy,vz,lx,ly,lz,tform,acc_rate,del_mass,rho_gas,cs**2,etherm,vx_gas,vy_gas,vz_gas,mbh,dmfsink,Mjet,level ")')
  !modified by PH 09/2023
  ...
  do isink=1,nsink
     ...
     write(123,'(I10,21(A1,ES21.10),A1,I10)')idsink(isink),',',msink(isink),&
          ...
          ',',msmbh(isink),',',dmfsink(isink),',',M_jet(isink),',',sinkint_level
  end do
