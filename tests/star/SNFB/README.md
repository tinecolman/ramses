...
Reaches 55 areas; most of its lines fall in **particles**, **mesh**, **gravity**. 366 lines are reached by no other test in the suite.
...
| amr_core | main_loop | 281 | 66% |  |
| utilities | rng | 82 | 64% |  |
| gravity | setup | 80 | 62% |  |

35 further areas exercised more lightly (under 10 lines or 25% of the area, and shared with other tests).
